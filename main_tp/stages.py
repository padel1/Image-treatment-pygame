...
class Stage:
    ...
    def main(self, screen, image, x, y):
        ...
        surf = pygame.transform.scale(
            (pygame.surfarray.make_surface(image)), MAIN_IMAGE_SIZE)
    ...
    def convertion(self, screen, image1, image2):
        ...
        screen.blit(pygame.transform.scale(
            (pygame.surfarray.make_surface(image1)), MAIN_IMAGE_SIZE), img_rect)
        img_rect = ((SCREEN_WIDTH-(150+MAIN_IMAGE_SIZE[1]), 190))
        screen.blit(pygame.transform.scale(
            (pygame.surfarray.make_surface(image2)), MAIN_IMAGE_SIZE), img_rect)
